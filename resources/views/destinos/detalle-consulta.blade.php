              ...
              <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-group">
                      ...
                      <div class="panel panel-success">
                        <div class="panel-heading">DESTINO FINAL:</div>
                      <div class="panel-body">
                        <div class="panel-body">
                           <div class="form-group"> 
                            <label for="sexo">Área:</label>
                            <select name="" id="" class="form-control" readonly>
                            ...
                            <div class="form-group"> 
                            <label for="sexo">Médico:</label>
                            <select name="" id="" class="form-control" readonly>
                            <option value="">Dr. Esmidio Rojas</option>
                            <option value="">Dr. Jorge Zavala</option>
                            <option value="">Dr. Hernán Pérez</option>
                            </select>
                            </div>
                             <div class="form-group"> 
                                <label for="nombres">Procedimiento</label>
                                <input type="text" name="nombres" class="form-control" value="Operación" readonly>
                             </div>
                             <div class="form-group"> 
                                <label for="nombres">Clínica:</label>
                                <input type="text" name="nombres" class="form-control" value="San Pablo" readonly>
                             </div>
                              <div class="form-group"> 
                                <label for="fnacimiento">Fecha</label>
                                <input type="date" name="fnacimiento" class="form-control" >
                              </div>
                              <div class="form-group"> 
                                <label for="nombres">Costo:</label>
                                <input type="text" name="nombres" class="form-control" value="S/.2000.00" readonly>
                             </div>
                      </div>
